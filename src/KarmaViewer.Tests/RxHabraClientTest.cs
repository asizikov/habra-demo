...
{
    [TestFixture]
    public class RxHabraClientTest : ReactiveTest
    {
        ...
        public void Test1()
        {
            ...
            var expected = Scheduler.CreateHotObservable(OnNext(200, Model), OnNext(201, NextModel), OnCompleted<KarmaModel>(201));
